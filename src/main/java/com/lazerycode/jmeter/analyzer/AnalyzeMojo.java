...
public class AnalyzeMojo extends AbstractMojo {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    try {
      ...
      Resource[] successes = resolver.getResources("file:" + source);
      ...
      if (resultDataFiles.length == 0) {
        ...
        Map<String,Map<String,AggregatedResponses>> datas=new HashMap<String, Map<String, AggregatedResponses>>();
        ...
        for (int dataFileIdentifier = 0; dataFileIdentifier < resultDataFiles.length; dataFileIdentifier++) {
          ...
          getLog().info(" ");
          datas.put(resultDataFile.getName(),jmeterResults);
        }

        getLog().info("Start index.");
        new HtmlIndexWriter().write(resultDataFiles,datas);
